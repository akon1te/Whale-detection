...
<p align="center">
    $ZCR=\frac{1}{T-1}\sum\limits^{T-1}_{t=1}\mathbb{I}(s_{t}s_{t-1}),$
</p>
...
<p align="center">
    <image src="images/stacking_results_AA.png" width=650>
</p>
Для B -> B
<p align="center">
    <image src="images/stacking_results_BB.png" width=650>
</p>
Для A -> B
<p align="center">
    <image src="images/stacking_results_AB.png" width=650>
</p>
Для B -> A
<p align="center">
    <image src="images/stacking_results_BA.png" width=650>
</p>
...
На каждой комбинации A и B частей датасета наилучший результат дают разные пары бустингов. Связка XGBoost + CatBoost выглядит наиболее универсальной, однако на ряду с ней XGBoost + XGBoost, XGBoost + OneDAL GBT и CatBoost + LightGBM также дают неплохие результаты. Результата XGBoost (ROC-AUC = 0.981), примененного единственный раз к набору полученных признаков превзойти не удалось. Свёрточные нейронные сети дают результат значительно хуже, даже в виде ансамбля и не могут конкурировать с прерыдущим вариантом. 
