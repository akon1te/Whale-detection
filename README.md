...
$$ZCR=\frac{1}{T-1}\sum^{T-1}_{t=1}\mathbb{I}\left\{s_{t}s_{t-1}\right\},$$

где $T$ - длина всего сигнала, $s_t$ - отрезок сигнала длины $t$, $\mathbb{I}$ - индикаторная функция.
...
Тут мы решили особо ничего не писать и просто вставить таблицу с наглядным сравнением результатов с тем, что было в [1] и [2]:
